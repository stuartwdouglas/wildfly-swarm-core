...
public class TracingInstaller implements DeploymentProcessor {
  ...
  private static final String CLIENT_BUILDER = DEPLOYMENT_PACKAGE + ".TracedClientBuilder";
  ...
  public void process() throws Exception {
    if (archive.getName().endsWith(".war")) {
      ...
      warArchive.addAsServiceProvider("javax.ws.rs.client.ClientBuilder", CLIENT_BUILDER);
